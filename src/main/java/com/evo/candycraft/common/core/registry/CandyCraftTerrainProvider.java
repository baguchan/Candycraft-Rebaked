...
public class CandyCraftTerrainProvider {
	...
	public static TerrainShaper candyworld() {
		ToFloatFunction<Float> tofloatfunction = NO_TRANSFORM;
		ToFloatFunction<Float> tofloatfunction1 = NO_TRANSFORM;
		ToFloatFunction<Float> tofloatfunction2 = NO_TRANSFORM;
	...
	private static CubicSpline<TerrainShaper.Point> buildErosionJaggednessSpline(float p_187295_, float p_187296_, float p_187297_, float p_187298_, ToFloatFunction<Float> p_187299_) {
		...
		return CubicSpline.builder(CandyCraftTerrainProvider.Coordinate.EROSION, p_187299_).addPoint(-1.0F, cubicspline, 0.0F).addPoint(-0.78F, cubicspline1, 0.0F).addPoint(-0.5775F, cubicspline1, 0.0F).addPoint(-0.375F, 0.0F, 0.0F).build();
	}
	...
	private static CubicSpline<TerrainShaper.Point> buildRidgeJaggednessSpline(float p_187301_, float p_187302_, ToFloatFunction<Float> p_187303_) {
		...
		float f2 = (f + f1) / 2.0F;
		CubicSpline.Builder<TerrainShaper.Point> builder = CubicSpline.builder(CandyCraftTerrainProvider.Coordinate.RIDGES, p_187303_);
	...
	private static CubicSpline<TerrainShaper.Point> buildWeirdnessJaggednessSpline(float p_187305_, ToFloatFunction<Float> p_187306_) {
		...
		return CubicSpline.builder(CandyCraftTerrainProvider.Coordinate.WEIRDNESS, p_187306_).addPoint(-0.01F, f, 0.0F).addPoint(0.01F, f1, 0.0F).build();
	}
	...
	private static CubicSpline<TerrainShaper.Point> getErosionFactor(float p_187308_, boolean p_187309_, ToFloatFunction<Float> p_187310_) {
		CubicSpline<TerrainShaper.Point> cubicspline = CubicSpline.builder(CandyCraftTerrainProvider.Coordinate.WEIRDNESS, p_187310_).addPoint(-0.2F, 6.3F, 0.0F).addPoint(0.2F, p_187308_, 0.0F).build();
		CubicSpline.Builder<TerrainShaper.Point> builder = CubicSpline.builder(CandyCraftTerrainProvider.Coordinate.EROSION, p_187310_).addPoint(-0.6F, cubicspline, 0.0F).addPoint(-0.5F, CubicSpline.builder(CandyCraftTerrainProvider.Coordinate.WEIRDNESS, p_187310_).addPoint(-0.05F, 6.3F, 0.0F).addPoint(0.05F, 2.67F, 0.0F).build(), 0.0F).addPoint(-0.35F, cubicspline, 0.0F).addPoint(-0.25F, cubicspline, 0.0F).addPoint(-0.1F, CubicSpline.builder(CandyCraftTerrainProvider.Coordinate.WEIRDNESS, p_187310_).addPoint(-0.05F, 2.67F, 0.0F).addPoint(0.05F, 6.3F, 0.0F).build(), 0.0F).addPoint(0.03F, cubicspline, 0.0F);
		if (p_187309_) {
			CubicSpline<TerrainShaper.Point> cubicspline1 = CubicSpline.builder(CandyCraftTerrainProvider.Coordinate.WEIRDNESS, p_187310_).addPoint(0.0F, p_187308_, 0.0F).addPoint(0.1F, 0.625F, 0.0F).build();
			CubicSpline<TerrainShaper.Point> cubicspline2 = CubicSpline.builder(CandyCraftTerrainProvider.Coordinate.RIDGES, p_187310_).addPoint(-0.9F, p_187308_, 0.0F).addPoint(-0.69F, cubicspline1, 0.0F).build();
			...
			CubicSpline<TerrainShaper.Point> cubicspline3 = CubicSpline.builder(CandyCraftTerrainProvider.Coordinate.RIDGES, p_187310_).addPoint(-0.7F, cubicspline, 0.0F).addPoint(-0.15F, 1.37F, 0.0F).build();
			CubicSpline<TerrainShaper.Point> cubicspline4 = CubicSpline.builder(CandyCraftTerrainProvider.Coordinate.RIDGES, p_187310_).addPoint(0.45F, cubicspline, 0.0F).addPoint(0.7F, 1.56F, 0.0F).build();
	...
	private static CubicSpline<TerrainShaper.Point> buildMountainRidgeSplineWithPoints(float p_187331_, boolean p_187332_, ToFloatFunction<Float> p_187333_) {
		CubicSpline.Builder<TerrainShaper.Point> builder = CubicSpline.builder(CandyCraftTerrainProvider.Coordinate.RIDGES, p_187333_);
		float f = -0.7F;
		float f1 = -1.0F;
	...
	private static CubicSpline<TerrainShaper.Point> buildErosionOffsetSpline(float p_187285_, float p_187286_, float p_187287_, float p_187288_, float p_187289_, float p_187290_, boolean p_187291_, boolean p_187292_, ToFloatFunction<Float> p_187293_) {
		...
		CubicSpline<TerrainShaper.Point> cubicspline7 = CubicSpline.builder(CandyCraftTerrainProvider.Coordinate.RIDGES, p_187293_).addPoint(-1.0F, p_187285_, 0.0F).addPoint(-0.4F, cubicspline5, 0.0F).addPoint(0.0F, p_187287_ + 0.07F, 0.0F).build();
	...
	private static CubicSpline<TerrainShaper.Point> ridgeSpline(float p_187277_, float p_187278_, float p_187279_, float p_187280_, float p_187281_, float p_187282_, ToFloatFunction<Float> p_187283_) {
		...
		return CubicSpline.builder(CandyCraftTerrainProvider.Coordinate.RIDGES, p_187283_).addPoint(-1.0F, p_187277_, f).addPoint(-0.4F, p_187278_, Math.min(f, f1)).addPoint(0.0F, p_187279_, f1).addPoint(0.4F, p_187280_, 2.0F * (p_187280_ - p_187279_)).addPoint(1.0F, p_187281_, 0.7F * (p_187281_ - p_187280_)).build();
	}
	...
	protected static enum Coordinate implements StringRepresentable, ToFloatFunction<TerrainShaper.Point> {
		...
		private static final Map<String, CandyCraftTerrainProvider.Coordinate> BY_NAME = Arrays.stream(values()).collect(Collectors.toMap(CandyCraftTerrainProvider.Coordinate::getSerializedName, (p_187371_) -> {
			return p_187371_;
		}));
		private static final Codec<CandyCraftTerrainProvider.Coordinate> CODEC = StringRepresentable.fromEnum(CandyCraftTerrainProvider.Coordinate::values, BY_NAME::get);
		static final Codec<ToFloatFunction<TerrainShaper.Point>> WIDE_CODEC = CODEC.flatComapMap((p_187365_) -> {
			return p_187365_;
		}, (p_187363_) -> {
			DataResult dataresult;
			if (p_187363_ instanceof CandyCraftTerrainProvider.Coordinate) {
				CandyCraftTerrainProvider.Coordinate terrainshaper$coordinate = (CandyCraftTerrainProvider.Coordinate) p_187363_;
