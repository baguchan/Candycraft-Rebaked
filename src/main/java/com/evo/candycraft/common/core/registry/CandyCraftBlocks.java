...
public class CandyCraftBlocks {
    ...
    public static final RegistryObject<Block> CANDY_CANE_SAPLING = HELPER.createBlockNoItem("candy_cane_sapling", () -> new ModSaplingBlock(ConfiguredFeatures.CANDY_CANE_TREE_FEATURE, AbstractBlock.Properties.create(Material.PLANTS, MaterialColor.WHITE_TERRACOTTA).zeroHardnessAndResistance().doesNotBlockMovement().tickRandomly().sound(SoundType.PLANT)));
    public static final RegistryObject<Block> POTTED_CANDY_CANE_SAPLING = HELPER.createBlockNoItem("potted_candy_cane_sapling", () -> new FlowerPotBlock(() -> (FlowerPotBlock) Blocks.FLOWER_POT, CANDY_CANE_SAPLING, AbstractBlock.Properties.create(Material.MISCELLANEOUS).hardnessAndResistance(0.0f).notSolid()));
    ...
    public static class Properties {
        public static final AbstractBlock.Properties WAFFLE_CONE_DOOR = AbstractBlock.Properties.from(Blocks.OAK_DOOR).sound(SoundType.NETHER_GOLD).harvestTool(ToolType.AXE);
        public static final AbstractBlock.Properties WAFFLE_CONE_TRAPDOOR = AbstractBlock.Properties.from(Blocks.OAK_TRAPDOOR).sound(SoundType.NETHER_GOLD).harvestTool(ToolType.AXE);
    }
}
