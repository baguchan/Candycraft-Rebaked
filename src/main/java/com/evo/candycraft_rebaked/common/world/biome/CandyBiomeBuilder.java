package com.evo.candycraft_rebaked.common.world.biome;

import com.evo.candycraft_rebaked.common.core.registry.CandyCraftBiomes;
...
public class CandyBiomeBuilder {
	...
	private final ResourceKey<Biome>[][] MIDDLE_BIOMES = new ResourceKey[][]{{CandyCraftBiomes.CREAMY_VALLEY, CandyCraftBiomes.CREAMY_VALLEY, CandyCraftBiomes.CREAMY_VALLEY, CandyCraftBiomes.COTTON_CANDY_WOODS, CandyCraftBiomes.COTTON_CANDY_WOODS}, {CandyCraftBiomes.CREAMY_VALLEY, CandyCraftBiomes.CREAMY_VALLEY, CandyCraftBiomes.COTTON_CANDY_WOODS, CandyCraftBiomes.COTTON_CANDY_WOODS, CandyCraftBiomes.COTTON_CANDY_WOODS}, {CandyCraftBiomes.COTTON_CANDY_WOODS, CandyCraftBiomes.CREAMY_VALLEY, CandyCraftBiomes.COTTON_CANDY_WOODS, CandyCraftBiomes.COTTON_CANDY_WOODS, CandyCraftBiomes.COTTON_CANDY_WOODS}, {CandyCraftBiomes.CREAMY_VALLEY, CandyCraftBiomes.CREAMY_VALLEY, CandyCraftBiomes.COTTON_CANDY_WOODS, CandyCraftBiomes.COTTON_CANDY_WOODS, CandyCraftBiomes.COTTON_CANDY_WOODS}, {CandyCraftBiomes.CREAMY_VALLEY, CandyCraftBiomes.CREAMY_VALLEY, CandyCraftBiomes.CREAMY_VALLEY, CandyCraftBiomes.CREAMY_VALLEY, CandyCraftBiomes.CREAMY_VALLEY}};
	...
	private final ResourceKey<Biome>[][] PLATEAU_BIOMES = new ResourceKey[][]{{CandyCraftBiomes.ROCK_CANDY_PEAKS, CandyCraftBiomes.ROCK_CANDY_PEAKS, CandyCraftBiomes.ROCK_CANDY_PEAKS, CandyCraftBiomes.COTTON_CANDY_WOODS, CandyCraftBiomes.COTTON_CANDY_WOODS}, {CandyCraftBiomes.ROCK_CANDY_PEAKS, CandyCraftBiomes.ROCK_CANDY_PEAKS, CandyCraftBiomes.COTTON_CANDY_WOODS, CandyCraftBiomes.COTTON_CANDY_WOODS, CandyCraftBiomes.COTTON_CANDY_WOODS}, {CandyCraftBiomes.ROCK_CANDY_PEAKS, CandyCraftBiomes.ROCK_CANDY_PEAKS, CandyCraftBiomes.ROCK_CANDY_PEAKS, CandyCraftBiomes.ROCK_CANDY_PEAKS, CandyCraftBiomes.ROCK_CANDY_PEAKS}, {CandyCraftBiomes.ROCK_CANDY_PEAKS, CandyCraftBiomes.ROCK_CANDY_PEAKS, CandyCraftBiomes.ROCK_CANDY_PEAKS, CandyCraftBiomes.ROCK_CANDY_PEAKS, CandyCraftBiomes.ROCK_CANDY_PEAKS}, {CandyCraftBiomes.ROCK_CANDY_PEAKS, CandyCraftBiomes.ROCK_CANDY_PEAKS, CandyCraftBiomes.ROCK_CANDY_PEAKS, CandyCraftBiomes.CREAMY_VALLEY, CandyCraftBiomes.CREAMY_VALLEY}};
	private final ResourceKey<Biome>[][] PLATEAU_BIOMES_VARIANT = new ResourceKey[][]{{null, null, null, null, null}, {null, null, null, null, null}, {null, null, null, null, null}, {null, null, CandyCraftBiomes.COTTON_CANDY_WOODS, CandyCraftBiomes.COTTON_CANDY_WOODS, null}, {null, null, null, null, null}};
	private final ResourceKey<Biome>[][] EXTREME_HILLS = new ResourceKey[][]{{CandyCraftBiomes.WOBBLY_HILLS, CandyCraftBiomes.WOBBLY_HILLS, CandyCraftBiomes.WOBBLY_HILLS, CandyCraftBiomes.COTTON_CANDY_WOODS, CandyCraftBiomes.COTTON_CANDY_WOODS}, {CandyCraftBiomes.WOBBLY_HILLS, CandyCraftBiomes.WOBBLY_HILLS, CandyCraftBiomes.WOBBLY_HILLS, CandyCraftBiomes.COTTON_CANDY_WOODS, CandyCraftBiomes.COTTON_CANDY_WOODS}, {CandyCraftBiomes.CREAMY_VALLEY, CandyCraftBiomes.CREAMY_VALLEY, CandyCraftBiomes.CREAMY_VALLEY, CandyCraftBiomes.COTTON_CANDY_WOODS, CandyCraftBiomes.COTTON_CANDY_WOODS}, {null, null, null, null, null}, {null, null, null, null, null}};
	...
	private void addOffCoastBiomes(Consumer<Pair<Climate.ParameterPoint, ResourceKey<Biome>>> p_187196_) {
		this.addSurfaceBiome(p_187196_, this.FULL_RANGE, this.FULL_RANGE, this.mushroomFieldsContinentalness, this.FULL_RANGE, this.FULL_RANGE, 0.0F, CandyCraftBiomes.CREAMY_VALLEY);

		this.addSurfaceBiome(p_187196_, this.FULL_RANGE, this.FULL_RANGE, this.deepOceanContinentalness, this.FULL_RANGE, this.FULL_RANGE, 0.0F, CandyCraftBiomes.RUNNY_RIVERS);
		this.addSurfaceBiome(p_187196_, this.FULL_RANGE, this.FULL_RANGE, this.oceanContinentalness, this.FULL_RANGE, this.FULL_RANGE, 0.0F, CandyCraftBiomes.RUNNY_RIVERS);
	}
	...
	private void addMidSlice(Consumer<Pair<Climate.ParameterPoint, ResourceKey<Biome>>> p_187218_, Climate.Parameter p_187219_) {
		this.addSurfaceBiome(p_187218_, this.FULL_RANGE, this.FULL_RANGE, this.coastContinentalness, Climate.Parameter.span(this.erosions[0], this.erosions[2]), p_187219_, 0.0F, CandyCraftBiomes.ROCK_CANDY_PEAKS);
		//Replace swamp to something
		this.addSurfaceBiome(p_187218_, this.UNFROZEN_RANGE, this.FULL_RANGE, Climate.Parameter.span(this.nearInlandContinentalness, this.farInlandContinentalness), this.erosions[6], p_187219_, 0.0F, CandyCraftBiomes.CHOCOLATE_BOG);
	...
	private void addLowSlice(Consumer<Pair<Climate.ParameterPoint, ResourceKey<Biome>>> p_187229_, Climate.Parameter p_187230_) {
		this.addSurfaceBiome(p_187229_, this.FULL_RANGE, this.FULL_RANGE, this.coastContinentalness, Climate.Parameter.span(this.erosions[0], this.erosions[2]), p_187230_, 0.0F, CandyCraftBiomes.ROCK_CANDY_PEAKS);
		//Replace swamp to something
		this.addSurfaceBiome(p_187229_, this.UNFROZEN_RANGE, this.FULL_RANGE, Climate.Parameter.span(this.nearInlandContinentalness, this.farInlandContinentalness), this.erosions[6], p_187230_, 0.0F, CandyCraftBiomes.CHOCOLATE_BOG);
	...
	private void addValleys(Consumer<Pair<Climate.ParameterPoint, ResourceKey<Biome>>> p_187238_, Climate.Parameter p_187239_) {
		this.addSurfaceBiome(p_187238_, this.FULL_RANGE, this.FULL_RANGE, this.coastContinentalness, Climate.Parameter.span(this.erosions[0], this.erosions[1]), p_187239_, 0.0F, p_187239_.max() < 0L ? CandyCraftBiomes.ROCK_CANDY_PEAKS : CandyCraftBiomes.RUNNY_RIVERS);
		this.addSurfaceBiome(p_187238_, this.FULL_RANGE, this.FULL_RANGE, this.nearInlandContinentalness, Climate.Parameter.span(this.erosions[0], this.erosions[1]), p_187239_, 0.0F, CandyCraftBiomes.RUNNY_RIVERS);

		this.addSurfaceBiome(p_187238_, this.FULL_RANGE, this.FULL_RANGE, Climate.Parameter.span(this.coastContinentalness, this.farInlandContinentalness), Climate.Parameter.span(this.erosions[2], this.erosions[5]), p_187239_, 0.0F, CandyCraftBiomes.RUNNY_RIVERS);
		this.addSurfaceBiome(p_187238_, this.FULL_RANGE, this.FULL_RANGE, this.coastContinentalness, this.erosions[6], p_187239_, 0.0F, CandyCraftBiomes.RUNNY_RIVERS);
		this.addSurfaceBiome(p_187238_, this.UNFROZEN_RANGE, this.FULL_RANGE, Climate.Parameter.span(this.inlandContinentalness, this.farInlandContinentalness), this.erosions[6], p_187239_, 0.0F, CandyCraftBiomes.CHOCOLATE_BOG);
		this.addSurfaceBiome(p_187238_, this.FULL_RANGE, this.FULL_RANGE, Climate.Parameter.span(this.inlandContinentalness, this.farInlandContinentalness), this.erosions[6], p_187239_, 0.0F, CandyCraftBiomes.RUNNY_RIVERS);
	...
	private void addUndergroundBiomes(Consumer<Pair<Climate.ParameterPoint, ResourceKey<Biome>>> p_187227_) {
		...
		//this.addUndergroundBiome(p_187227_, Climate.Parameter.span(-1.0F, 0.0F), Climate.Parameter.span(0.5F, 1.0F), this.FULL_RANGE, this.FULL_RANGE, this.FULL_RANGE, 0.0F, CandyCraftBiomes.ROCK_CANDY_PEAKS);
	}
	...
	private ResourceKey<Biome> pickBeachBiome(int p_187161_, int p_187162_) {
		//TODO make etter beach
		if (p_187161_ == 0) {
			return CandyCraftBiomes.ROCK_CANDY_PEAKS;
		} else {
			return CandyCraftBiomes.ROCK_CANDY_PEAKS;
		}
	}
